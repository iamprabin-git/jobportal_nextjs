...
const WhatsAppButton = ({
  phoneNumber = "+977-98080883620",
  defaultMessage = "Hello, I am interested in your services!",
  messageOptions = [
    { text: "Service Inquiry", message: "I would like more information about your services" },
    { text: "Get Quote", message: "Can you provide a quote for..." },
    { text: "Schedule Meeting", message: "I would like to schedule a meeting" },
